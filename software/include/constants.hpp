    ...
    #define MOCKED_DATA_LOGFILE (char*)""               // No mocked data logfile for FLIGHT_BUILD
    #define VERBOSE false                               // Disable verbosity
    #define MANUAL_MODE false                           // Use real sensors
   
#else

    #ifdef TEST_BUILD            // constants for test build

        #define MOCKED_DATA_LOGFILE (char*)"lessdata.csv"   // Mocked data file to use for MANUAL_MODE
